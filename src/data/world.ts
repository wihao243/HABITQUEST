...
export const WORLD_REGIONS: Region[] = [
  {
    ...
    monsters: [
      ...
      { id: 'm2', name: 'Duende del Sueño', avatar: '👺', level: 2, hp: 45, maxHp: 45, damage: 8, xpReward: 5, goldReward: 3, description: 'Te lanza polvos mágicos que te dan ganas de dormir.' },
